...
class App:
    ...
    def save_session_dialog(self):
        """セッション保存ダイアログ"""
        # 各タブの on_hide を呼んで state を最新化
        self._sync_current_tab_to_state()
